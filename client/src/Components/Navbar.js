            ...
            <nav className="flex max-w-screen-xl px-6 py-3 mx-10">    
                <Fade top>
                    <div className="container hidden space-x-8 md:flex lg:flex mx-28">
                        ...
                        <div className="items-center hidden space-x-40 md:flex lg:flex">
                            <button className="absolute flex items-center justify-center h-8 text-black border-2 border-green-600 border-solid rounded-lg w-28 poppins" onClick={() => history.push('/register')}>Register</button>
                            <button className="absolute flex items-center justify-center h-8 text-white bg-green-700 w-28 rounded-xl poppins" onClick={() => history.push('/login')}>Login</button>
                        </div>
                    </div>
                </Fade>        
            </nav>
